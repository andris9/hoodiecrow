...
storeHandlers["+FLAGS"] = function(connection, messages, isUid, flags, parsed, data, cb) {
	async.waterfall([
		function (cb) {
	    connection.addFlags(messages, isUid, _.pluck(flags,"value"), cb);
		},
		function (msgs,cb) {
	    sendUpdate(connection, parsed, data, msgs, cb);
		}
...
storeHandlers["-FLAGS"] = function(connection, messages, isUid, flags, parsed, data, cb) {
	async.waterfall([
		function (cb) {
	    connection.removeFlags(messages, isUid, _.pluck(flags,"value"), cb);
		},
		function (msgs,cb) {
	    sendUpdate(connection, parsed, data, msgs, cb);
		}
...
storeHandlers["FLAGS.SILENT"] = function(connection, messages, isUid, flags, parsed, data, cb) {
    connection.replaceFlags(messages, isUid, _.pluck(flags,"value"), cb);
};
