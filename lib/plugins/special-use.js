 ...
 * @help Mailboxes need to have a "special-use" property (String or Array)
 * @help that will be used as extra flag for LIST and LSUB responses
 */
...
module.exports = function(server){
    ...
    server.outputHandlers.push(function(connection, response, description, parsed, data, folder){
        ...
        [].concat(folder && folder["special-use"] || []).forEach(function(specialUse){
            if(specialUse.toUpperCase() != "\\INBOX"){ // Ignore \Inbox, only needed for XLIST
                specialUseList.push({type: "ATOM", value: specialUse});
            }
        });
