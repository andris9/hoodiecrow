            ...
            switch((parsed.attributes[0].value || "").toUpperCase()){
                case "SERVER":
                    connection.send({
                        ...
                        command: "XTOYBIRD",
                        attributes:[
                            {type: "SECTION", section:[{type: "ATOM", value: "XDUMPVAL"}]},
                ...
                case "STORAGE":
                    connection.send({
                        ...
                        command: "XTOYBIRD",
                        attributes:[
                            {type: "SECTION", section:[{type: "ATOM", value: "XJSONDUMP"}]},
                ...
                case "USERADD":
                    ...
                    connection.send({
                        ...
                        command: "XTOYBIRD",
                        attributes:[
                            {type: "SECTION", section:[{type: "ATOM", value: "XUSER"}]},
                            {type: "TEXT", value: "User '" + username + "' " + message + " successfully"}
                        ]
                ...
                case "USERDEL":
                    ...
                    connection.send({
                        ...
                        attributes:[
                            {type: "SECTION", section:[{type: "ATOM", value: "XUSER"}]},
                            {type: "TEXT", value: "Removing user '" + username + "' " + message}
                        ]
                ...
                case "SHUTDOWN":
                    connection.send({
                        ...
                        command: "OK",
                        attributes:[
                            {type: "SECTION", section:[{type: "ATOM", value: "ALERT"}]},
                            {type: "TEXT", value: "System scheduled for shutdown"}
                        ]
