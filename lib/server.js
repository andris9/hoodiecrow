...
IMAPMockConnection.prototype.processCommand = function(data, callback){
    ...
    switch(command){
        ...
        case "store":
            return this.handleSTORE(tag, data, callback);
        case "noop":
            return this.handleNOOP(tag, data, callback);
        case "idle":
            return this.handleIDLE(tag, data, callback);
        case "logout":
            return this.handleLOGOUT(tag, data, callback);
        default:
...
IMAPMockConnection.prototype.handleSTORE = function(tag, data, callback){
    if(["Authenticated", "Selected"].indexOf(this.state) < 0){
        this.send(tag, "BAD Unknown command");
        return callback();
    }
...
IMAPMockConnection.prototype.handleLOGOUT = function(tag){
    this.state = "Logout";
    ...
    list.forEach((function(param){
        switch(param && param.value || param){
            ...
            case "BODY":
                ...
                break;
            case "BODYSTRUCTURE":
                response[param] = bodystructure(message.structured, {upperCaseKeys: true});
                break;
            case "ENVELOPE":
