...
IMAPServer.prototype.createMailbox = function(path, defaultMailbox){
    ...
    folderPath.forEach((function(folderName){
        ...
        }if(folder.namespace == this.referenceNamespace){
...
IMAPServer.prototype.matchFolders = function(reference, match){
    ...
    if(reference === "" && this.referenceNamespace !== false && ["*", "%"].indexOf(match.charAt(0)) >= 0){
    ...
    if(includeINBOX && (reference + namespace.separator + "INBOX").match(query)){
