...
IMAPServer.prototype.processMailbox = function(path, mailbox, namespace){
    ...
    mailbox.permanentFlags = [].concat(mailbox.permanentFlags ||
        ...
        (this.selectedMailbox &&
            this.selectedMailbox == (
                typeof notification.mailbox == "string" &&
                    this.folderCache[notification.mailbox] || notification.mailbox))){
...
IMAPConnection.prototype.expungeDeleted = function(mailbox, ignoreSelf){
    var deleted = 0;
